...
const CLIENT_ID_GG =
  "324350435117-0t20qgbopolsmdrcgft8792l2thi311h.apps.googleusercontent.com";
...
router.get(
  "/checkout-by-momo-success",
  isLoggined,
  siteController.checkoutByMomoSuccess
);
// [GET] /checkout-by-momo-success
router.get(
  "/checkout-by-momo-error",
  isLoggined,
  siteController.checkoutByMomoError
);
